...
/**
 * Servlet implementation class EmployeeeDetailsServlet
 */
@WebServlet("/EmployeeeDetailsServlet")
public class EmployeeeDetailsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeeDetailsServlet() {
        super();
